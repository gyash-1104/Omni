...
EXTRACTABLE_FIELDS = {
    ...
    # Secondary Context
    "builder_name": "Name of the builder or developer (if mentioned)",
    "site_ready": "true if the site is ready for interiors, false otherwise",
    "material_preferences": "List of materials mentioned e.g. [veneer, acrylic, marble, timber]",
    "lighting_preference": "One of: warm, cool, natural, smart, dimmable, bright",
    "family_size": "Number of family members (integer)",
    "work_from_home": "true if client works from home or needs an office setup",
    "hosting_frequency": "One of: frequent, occasional, rarely",
    "maintenance_preference": "One of: low_maintenance, standard",
    "smart_home_interest": "true if client wants smart home integration",
    "floor_plan_available": "true if client has floor plan ready",
    "structural_changes_allowed": "true if civil/structural changes are permitted",
    "electrical_changes_allowed": "true if electrical rewiring is permitted",
}
...
class StructuredExtractor:
    ...
    def _normalize(self, raw: dict) -> dict:
        ...
        result = {}
        bool_fields = {
            "false_ceiling_required", "kids", "pets", "elderly", "pooja_room",
            "site_ready", "work_from_home", "smart_home_interest",
            "floor_plan_available", "structural_changes_allowed", "electrical_changes_allowed"
        }
        list_fields = {
            "rooms_to_design", "color_preferences", "must_have_features",
            "avoid_items", "design_inspiration_words", "material_preferences"
        }
        ...
        for k, v in raw.items():
            ...
            if k in bool_fields:
                ...
                if isinstance(v, list):
                    ...
                    result[k] = [v]
            elif k in ("wardrobe_count", "family_size"):
                try:
                    result[k] = int(v)
